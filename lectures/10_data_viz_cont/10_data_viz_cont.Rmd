...
subtitle: "10: Visualizing Data in Python"
...
np.random.seed(2024) # so we get the same random sample
...
.pull-right[
```{python plotnine1_out,  echo=FALSE}
from plotnine import ggplot, aes, geom_histogram, labs, theme_minimal
...
.pull-right[
```{python plotnine2_out,  echo=FALSE}
from plotnine import ggplot, aes, geom_histogram, labs, theme_minimal
...
.pull-right[
```{python plotnine3_out,  echo=FALSE}
from plotnine import ggplot, aes, geom_histogram, labs, theme_minimal
...
.pull-right[
```{python plotnine4_out,  echo=FALSE}
from plotnine import ggplot, aes, geom_histogram, labs, theme_minimal
...
- Annotate the plot with the `country` variable.
...
```{python network_plot, echo=FALSE, out.width='45%', fig.align='center'}
